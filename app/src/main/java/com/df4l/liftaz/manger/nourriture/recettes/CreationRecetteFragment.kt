...
class CreationRecetteFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val editQuantitePortion = view.findViewById<TextInputEditText>(R.id.editQuantitePortion)
        editQuantitePortion.addTextChangedListener(object : TextWatcher {
            override fun afterTextChanged(s: Editable?) {
                // Recalcule les macros à chaque modification
                updateTotalMacros()
            }
